...
updateEventForm.addEventListener("submit", function (e) {
    ...
    let inputType = document.getElementById("mySelect");
    let inputAttendance = document.getElementById("input-attendance");
    ...
    let data = {
        ...
        event_attendance: attendanceValue,
    }
    ...
    window.location.href = 'http://flip1.engr.oregonstate.edu:9326/event';
})
